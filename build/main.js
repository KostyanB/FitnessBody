...
;// CONCATENATED MODULE: ./src/modules/rafAnimate.js
...
/* harmony default export */ const rafAnimate = (animate);
;// CONCATENATED MODULE: ./src/modules/falloutMenu.js
...
var dropMenu = function dropMenu() {
  ...
  var menuAnim = function menuAnim() {
    var stopPosMenu = falloutActivator.getBoundingClientRect().bottom + 15;
    ...
    rafAnimate({
      ...
      draw: function draw(progress) {
        var menuPos = clubSelector.getBoundingClientRect().top,
            startPosMenu = -100,
            posMenu = startPosMenu + (stopPosMenu - startPosMenu) * progress;

        if (menuPos < stopPosMenu) {
          clubSelector.style.transform = "translateY(".concat(posMenu, "%)");
        }
      }
    });
  };
...
/* harmony default export */ const falloutMenu = (dropMenu);
;// CONCATENATED MODULE: ./src/modules/showPopup.js




var showPopupForm = function showPopupForm(thanksForm) {
  var openFreeVisit = document.querySelector('.open-free'),
  ...
  var animForm = function animForm(wrapper) {
    rafAnimate({
      duration: 300,
      timing: function timing(timeFraction) {
        return timeFraction;
      ...
      draw: function draw(progress) {
        var startPosPopup = -100,
            posMenu = startPosPopup + (0 - startPosPopup) * progress;
        wrapper.style.transform = "translateY(".concat(posMenu, "%)");
      }
    });
  };

  var controlForm = function controlForm(tagetForm, targetWrapper) {
    tagetForm.style.display = 'block';
    targetWrapper.style.transform = "translateY(-100%)";
    animForm(targetWrapper);
  };

  var closeThanks = function closeThanks() {
    return thanksForm.style.display = 'none';
  };
  ...
  document.addEventListener('click', function (e) {
    ...
    if (giftBtn) {
      var giftForm = document.getElementById('gift'),
    ...
    if (thanksForm) {
      var closeThanksForm = thanksForm.querySelectorAll('.close-form'),
...
/* harmony default export */ const showPopup = (showPopupForm);
;// CONCATENATED MODULE: ./src/modules/headSlider.js
/* eslint-disable linebreak-style */


var sliderHead = function sliderHead() {
  ...
  var startSlidePlay = function startSlidePlay() {
...
/* harmony default export */ const headSlider = (sliderHead);
;// CONCATENATED MODULE: ./src/modules/addArrow.js
...
var AddArrow = /*#__PURE__*/function () {
  function AddArrow(_ref) {
    var wrap = _ref.wrap,
        wrapName = _ref.wrapName,
        placeName = _ref.placeName;

    _classCallCheck(this, AddArrow);
  ...
  _createClass(AddArrow, [{
    key: "setBtn",
    value: function setBtn() {
      this.prevBtn.className = "".concat(this.wrapName, "-arrow prev ").concat(this.placeName, "-prev");
      this.nextBtn.className = "".concat(this.wrapName, "-arrow next ").concat(this.placeName, "-next");
...
/* harmony default export */ const addArrow = (AddArrow);
;// CONCATENATED MODULE: ./src/modules/addDots.js


function addDots_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function addDots_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function addDots_createClass(Constructor, protoProps, staticProps) { if (protoProps) addDots_defineProperties(Constructor.prototype, protoProps); if (staticProps) addDots_defineProperties(Constructor, staticProps); return Constructor; }

var AddDots = /*#__PURE__*/function () {
  function AddDots(_ref) {
    var wrap = _ref.wrap,
        wrapName = _ref.wrapName,
        slidesName = _ref.slidesName;

    addDots_classCallCheck(this, AddDots);
  ...
  addDots_createClass(AddDots, [{
    key: "addDot",
    value: function addDot() {
      var _this = this;

      var slides = document.querySelectorAll(this.slidesName);
      var newDot = document.createElement('li');
      newDot.className = "".concat(this.wrapName, "-dot");
      slides.forEach(function (item, i) {
        item[i] = newDot.cloneNode(true);

        _this.dotsWrap.append(item[i]);
      });
      var sliderDot = document.querySelectorAll(".".concat(this.wrapName, "-dot"));
...
/* harmony default export */ const addDots = (AddDots);
;// CONCATENATED MODULE: ./src/modules/photoGallery.js
...
var photoSlider = function photoSlider() {
  ...
  for (var i = 1; i < photoSlides.length; i++) {
    photoSlides[i].style.display = 'none';
  } // установка css


  var addClass = function addClass() {
    var style = document.getElementById('gallery-style');
  ...
  addClass(); // добавление dot на страницу

  var galleryDots = new addDots({
    wrap: '.gallery-slider',
    wrapName: 'slider',
    slidesName: '.photo-slide'
  });
  galleryDots.init(); // добавление кнопок на страницу

  var galleryBtns = new addArrow({
    wrap: '.gallery-slider',
    wrapName: 'slider',
    placeName: 'gallery'
  });
  galleryBtns.init();
  var galleryPrevBtn = document.querySelector('.slider-arrow.prev'),
      galleryNextBtn = document.querySelector('.slider-arrow.next'); // смена слайдов и dot
  ...
  var prevDot = function prevDot(elem, index, strClass) {
    elem[index].classList.remove(strClass);
  };

  var nextDot = function nextDot(elem, index, strClass) {
  ...
  var stopSlidePlay = function stopSlidePlay() {
  ...
  gallerySlider.addEventListener('click', function (e) {
    ...
    if (target.closest('.gallery-next')) {
      ...
      sliderDot.forEach(function (elem, index) {
        if (elem === target) {
          currentSlide = index;
        }
      });
  ...
  gallerySlider.addEventListener('mouseover', function (e) {
    if (e.target.parentNode.classList.contains('slider-arrow') || e.target.matches('.slider-dot')) {
      //parentNode.classList.contains('slider-dot'))
      stopSlidePlay();
    }
  });
...
/* harmony default export */ const photoGallery = (photoSlider);
;// CONCATENATED MODULE: ./src/modules/sliderCarousel.js
...
var sliderCarousel = function sliderCarousel() {
  ...
  var slides = document.querySelectorAll('.services-slide_content');
  var slidesToShow = 5;
  var widthSlide = Math.floor(100 / slidesToShow);
  var maxPosition; // установка css

  var addStyle = function addStyle() {
    var style = document.getElementById('services-style');
  ...
  var setOptionPosition = function setOptionPosition() {
    widthSlide = 100 / slidesToShow;
    maxPosition = slides.length - slidesToShow;
    var sliderWidth = servicesSlider.clientWidth / slidesToShow;
  ...
  setOptionPosition(); // количество слайдов от разрешения экрана

  var responseInit = function responseInit() {
    var slidesDefault = slidesToShow;
    var allResponse = responsive.map(function (item) {
    ...
    var checkResponse = function checkResponse() {
      ...
      if (widthWindow < maxResponse) {
        for (var _i = 0; _i < allResponse.length; _i++) {
          if (widthWindow < allResponse[_i]) {
            slidesToShow = responsive[_i].slidesToShow;
            setOptionPosition();
          }
        }
      } else {
  ...
  responseInit(); // прокрутка слайдов
...
/* harmony default export */ const modules_sliderCarousel = (sliderCarousel);
;// CONCATENATED MODULE: ./src/modules/maskPhone.js


function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = maskPhone_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }

function maskPhone_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return maskPhone_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return maskPhone_arrayLikeToArray(o, minLen); }

function maskPhone_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
...
;// CONCATENATED MODULE: ./src/modules/maskInput.js
...
/* harmony default export */ const modules_maskInput = (maskInput);
;// CONCATENATED MODULE: ./src/modules/validInput.js
...
var validInput = function validInput() {
  ...
  document.body.addEventListener('change', function (e) {
    ...
    var showError = function showError(error) {
      var selectForm = e.target.closest('form');

      if (selectForm) {
        var submitBtn = selectForm.querySelector('.btn'); //подсветка ошибок
        ...
        if (Object.values(correctBase).every(function (item) {
          return item;
        })) {
    ...
    if (e.target.className === 'form-name') {
      ...
      var nameData = e.target.value.trim().split(' '),
          userName = '',
          baseName = '';
      nameData.forEach(function (item) {
        baseName += "".concat(item.charAt(0).toUpperCase() + item.substring(1), " ");
    ...
    if (e.target.className === 'form-phone') {
      e.target.value = e.target.value.replace(/^\+\d{1}\s/g, '+7 '); // проверка на количество цифр

      var corrNum = e.target.value.replace(/[\s\+\(\)-]*/g, '');
...
/* harmony default export */ const modules_validInput = (validInput);
;// CONCATENATED MODULE: ./src/modules/showMessage.js
 // показ сообщения об отправке

var statusMessage = document.createElement('div');
statusMessage.style.cssText = 'font-size: 1.2em';
var showMessage = function showMessage(color, message) {
...
var calc = function calc() {
  ...
  if (cardOrder.className !== 'calc-card-order') {
    ...
    var priceTotal = cardOrder.querySelector('#price-total'),
    ...
    var targetClub, targetTime, price;
    var basePrice = {
      'mozaika1': 1999,
      'mozaika6': 9990,
      'mozaika9': 13990,
    ...
    var calculator = function calculator(sale, price) {
      if (priceTotal) {
        priceTotal.textContent = Math.round(price * sale);
      }
    };

    var setTarif = function setTarif() {
      var sale = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      ...
      var tarif = "".concat(targetClub).concat(targetTime);
    ...
    checkPromo();
    cardOrder.addEventListener('click', function (e) {
    ...
    var formChange = function formChange() {
      if (formPromo) {
        formPromo.addEventListener('change', function () {
          checkPromo();
        });
      }
    };
...
/* harmony default export */ const calculator = (calc);
;// CONCATENATED MODULE: ./src/modules/clearInputs.js




var clearInputs = function clearInputs() {
  var inputs = targetForm.querySelectorAll('input');
  ...
  var checkBox = targetForm.querySelector('[type="checkbox"]');

  if (checkBox) {
    checkBox.checked = "false";
  }
};
;// CONCATENATED MODULE: ./src/modules/showSendResult.js
...
var errorMessage = 'Ошибка отправки. Попробуйте еще раз позже.',
    errorColor = '#fe193f',
    thanksForm = document.getElementById('thanks');
var successResult = function successResult() {
  var formElem = targetForm.children;
  ...
  statusMessage.textContent = '';
  clearInputs();
  var fullForm = targetForm.closest('.popup');

  if (targetForm.closest('.popup')) {
    fullForm.style.display = 'none';
  }

  showPopup(thanksForm);
};
var errorResult = function errorResult(error) {
  if (error) {
    console.error(error);
  }

  if (targetForm.id === 'banner-form') {
    var messageForm = document.getElementById('thanks-text');
...
var sendForm = function sendForm() {
  var loadMessage = 'Отправка...',
      loadColor = '#19b5fe'; //отправка данных на сервер
...
;// CONCATENATED MODULE: ./src/modules/checkInputs.js




var targetForm; //форма из которой отправлена заявка
// проверка инпутов
...
var checkInputs = function checkInputs() {
  ...
  var checkForm = function checkForm() {
    if (targetForm.closest('footer')) {
      var clubCheck = targetForm.querySelectorAll('[type="radio"]'); // проверка выбран ли клуб в футере
      ...
      var targetCheck = targetForm.querySelector('[type="checkbox"]');
      targetCheck.removeAttribute('required'); // проверка выбран ли чекбокс перс. данных
...
/* harmony default export */ const modules_burgerMenu = (burgerMenu);
;// CONCATENATED MODULE: ./src/modules/popupMenu.js




var popupMenu = function popupMenu() {
  var popMenu = document.querySelector('.popup-menu'),
      menuBtn = document.getElementById('menu-button');

  var popMenuAnim = function popMenuAnim() {
    rafAnimate({
      duration: 300,
      timing: function timing(timeFraction) {
        return timeFraction;
      ...
      draw: function draw(progress) {
        ...
        popMenu.style.transform = "translateY(".concat(posMenu, "%)");
      }
    });
  };
...
/* harmony default export */ const modules_popupMenu = (popupMenu);
;// CONCATENATED MODULE: ./src/modules/scrollCursor.js


var scrollCursor = function scrollCursor() {
...
/* harmony default export */ const modules_scrollCursor = (scrollCursor);
;// CONCATENATED MODULE: ./src/modules/scrollLink.js


var scrollToLink = function scrollToLink() {
  var popMenu = document.querySelector('.popup-menu'),
      topMenu = document.querySelector('.main-links'); // скролл на секцию

  var goLink = function goLink(href) {
    var topOffset = document.querySelector('.top-menu').offsetHeight,
        scrollTarget = document.getElementById(href),
        elementPosition = scrollTarget.getBoundingClientRect().top,
        offsetPosition = elementPosition - topOffset;
    window.scrollBy({
      top: offsetPosition,
      // 0 если не нужен отступ сверху
  ...
  var addLink = function addLink(e, menuClass) {
    var menu = document.querySelector(menuClass);
    var idElem = e.target.href.split('#')[1];
...
/* harmony default export */ const scrollLink = (scrollToLink);
...
showPopup(); // слайдер на главной

headSlider(); // фотогалерея

photoGallery(); // карусель

modules_sliderCarousel(); // маски инпутов

modules_maskInput(); //validInput();

modules_validInput(); // проверка чекбоксов при сабмитах

checkInputs(); // калькулятор

calculator(); // скролл бургер-меню

modules_burgerMenu(); // poup-menu

modules_popupMenu(); // стрелка при скролле

modules_scrollCursor(); // плавный скролл
